...
Version 5.3.2 keeps the compact route-reference architecture and deterministic
...
```text
Copy the folder from https://github.com/rqzhu-aide/causal-consultant/tree/v5.3.2 into `~/.codex/skills/causal-consultant`.
```

Claude Code personal install:

```text
Copy the folder from https://github.com/rqzhu-aide/causal-consultant/tree/v5.3.2 into `~/.claude/skills/causal-consultant`.
```

Codex or other agent project-local install:

```text
Copy the folder from https://github.com/rqzhu-aide/causal-consultant/tree/v5.3.2 into `.agents/skills/causal-consultant`.
```

Alternative project-local install:

```text
Copy the folder from https://github.com/rqzhu-aide/causal-consultant/tree/v5.3.2 into `.agent/skills/causal-consultant`.
```
...
Invoke-WebRequest "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.3.2/project-hooks/.codex/hooks.json" -OutFile ".codex\hooks.json"
Invoke-WebRequest "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.3.2/project-hooks/.codex/project_state_stop_check.js" -OutFile ".codex\project_state_stop_check.js"
```
...
```sh
mkdir -p .codex
curl -L "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.3.2/project-hooks/.codex/hooks.json" -o .codex/hooks.json
curl -L "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.3.2/project-hooks/.codex/project_state_stop_check.js" -o .codex/project_state_stop_check.js
```
...
Invoke-WebRequest "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.3.2/project-hooks/.claude/settings.json" -OutFile ".claude\settings.json"
Invoke-WebRequest "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.3.2/project-hooks/.claude/project_state_stop_check.js" -OutFile ".claude\project_state_stop_check.js"
```
...
```sh
mkdir -p .claude
curl -L "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.3.2/project-hooks/.claude/settings.json" -o .claude/settings.json
curl -L "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.3.2/project-hooks/.claude/project_state_stop_check.js" -o .claude/project_state_stop_check.js
```
