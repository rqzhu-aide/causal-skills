...
Version 5.2.0 keeps the compact route-reference architecture and deterministic
...
delivery may vary only in nonmaterial presentation while preserving the
committed decision contract. Runtime use requires Node.js 18 or newer. The
...
```text
Copy the folder from https://github.com/rqzhu-aide/causal-consultant/tree/v5.2.0 into `~/.codex/skills/causal-consultant`.
```

Claude Code personal install:

```text
Copy the folder from https://github.com/rqzhu-aide/causal-consultant/tree/v5.2.0 into `~/.claude/skills/causal-consultant`.
```

Codex or other agent project-local install:

```text
Copy the folder from https://github.com/rqzhu-aide/causal-consultant/tree/v5.2.0 into `.agents/skills/causal-consultant`.
```

Alternative project-local install:

```text
Copy the folder from https://github.com/rqzhu-aide/causal-consultant/tree/v5.2.0 into `.agent/skills/causal-consultant`.
```
...
Invoke-WebRequest "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.2.0/project-hooks/.codex/hooks.json" -OutFile ".codex\hooks.json"
Invoke-WebRequest "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.2.0/project-hooks/.codex/project_state_stop_check.js" -OutFile ".codex\project_state_stop_check.js"
```
...
```sh
mkdir -p .codex
curl -L "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.2.0/project-hooks/.codex/hooks.json" -o .codex/hooks.json
curl -L "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.2.0/project-hooks/.codex/project_state_stop_check.js" -o .codex/project_state_stop_check.js
```
...
Invoke-WebRequest "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.2.0/project-hooks/.claude/settings.json" -OutFile ".claude\settings.json"
Invoke-WebRequest "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.2.0/project-hooks/.claude/project_state_stop_check.js" -OutFile ".claude\project_state_stop_check.js"
```
...
```sh
mkdir -p .claude
curl -L "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.2.0/project-hooks/.claude/settings.json" -o .claude/settings.json
curl -L "https://raw.githubusercontent.com/rqzhu-aide/causal-consultant/v5.2.0/project-hooks/.claude/project_state_stop_check.js" -o .claude/project_state_stop_check.js
```
