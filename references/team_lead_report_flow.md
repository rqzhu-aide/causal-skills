...
Results-focused reporting requires available analysis artifacts that match the
report scope. Without them, offer only a planning report or bounded
claim-language work. If purpose, audience, evidence basis, or claim boundary is
unclear, ask for the smallest clarification that could change the scope.
